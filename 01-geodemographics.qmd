...
#| filename: "R code"
# elbow plot
fviz_nbclust(lsoa_df_vis[,-1], kmeans, nstart = 25, iter.max = 200, method = 'wss') 
```
...
::: {.callout-note}
1.  Your function could be structured like this: `run_kmeans(df, k, vars)`, where `df` is your input dataframe, `k` is the number of clusters, and `vars` is a list of input variables. 
